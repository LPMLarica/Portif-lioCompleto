...
if page == "Home":
    ...
    certificates = [
        ...
        str(Path("certificados") / "StatementOfResult_page-0001.png"),
        ...
        str(Path("certificados") / "D3RDYUNF_page-0001.png"),
        str(Path("certificados") / "OFAASOFA.png"), 
        str(Path("certificados") / "Captura de tela 2025-11-12 180515.png"),
        str(Path("certificados") / "Captura de tela 2025-11-12 180635.png"),
        ...
        str(Path("certificados") / "Captura de tela 2025-11-11 140612.png"),
        str(Path("certificados") / "Captura de tela 2025-10-30 125158.png"),
        str(Path("certificados") / "Captura de tela 2025-10-30 125221.png"),
        ...
        str(Path("certificados") / "2RNXOLZZ_page-0001.png"),
        str(Path("certificados") / "Captura de tela 2025-11-26 134753.png"),
        str(Path("certificados") / "Captura de tela 2025-11-26 134745.png"),
        str(Path("certificados") / "WQWO57ZD_page-0001.png"),
